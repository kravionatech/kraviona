...
import { Camera, Mail, Pencil, Save, ShieldCheck, UserRound, X } from "lucide-react";
...
function Detail({ label, value }) {
  return <div className="rounded-xl border border-[#0f5960]/10 bg-[#f8fbfa] px-4 py-3"><dt className="text-[10px] font-black uppercase tracking-[0.14em] text-[#5d7679]">{label}</dt><dd className="mt-1 break-words text-sm font-semibold text-[#123f46]">{value || "No data found."}</dd></div>;
}

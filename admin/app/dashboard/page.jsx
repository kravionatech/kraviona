  ...
  return <Frame>
    <main className="min-h-full bg-[#f4f8f7] px-4 py-6 sm:px-6 lg:px-9 lg:py-8">
      <div className="mx-auto max-w-[1600px]">
        <section className="relative isolate z-10 mb-6 rounded-[28px] border border-[#0f5960]/20 bg-gradient-to-br from-[#0b363d] via-[#0f5960] to-[#1a6870] p-5 text-white shadow-2xl shadow-[#0f5960]/20 sm:p-6">

...
// Pre-save hook to refresh lastUpdated and handle auto-flagging
contentPlanItemSchema.pre("save", function (next) {
  this.lastUpdated = new Date();

  // If status is "Needs Update", ensure isOutdated is true
  if (this.status === "Needs Update") {
    this.isOutdated = true;
  }

  // If published date is set and older than 90 days, or planned date is older than 90 days for completed items

...
const CTA = () => {
  return (
    <section className="relative w-full py-24 bg-[#1A2E33] flex justify-center items-center overflow-hidden font-sans border-t border-white/5">
      {/* Background Ambient Glows */}
      <div className="absolute inset-0 pointer-events-none z-0 flex items-center justify-center">
        <div className="absolute w-[50rem] h-[50rem] bg-gradient-to-tr from-[#E8622A]/20 to-[#2A4A52]/20 rounded-full blur-[150px] mix-blend-screen"></div>
        <div
      ...
      <div className="max-w-6xl mx-auto px-6 w-full relative z-10">
        ...
        >
          ...
          <motion.div
            ...
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[30rem] h-[30rem] bg-[#F28C5E] rounded-full blur-[120px] pointer-events-none"
          ></motion.div>

          {/* Overline Badge */}
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-[#E8622A]/10 border border-[#E8622A]/30 mb-8 relative z-10">
            <Rocket className="w-4 h-4 text-[#E8622A] animate-bounce" />
            <span className="text-[#F28C5E] font-bold tracking-[0.2em] text-[10px] sm:text-xs uppercase">
              Ready To Scale?
            </span>
          </div>
          ...
          <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white tracking-tighter leading-[1.05] mb-6 relative z-10">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E8622A] via-[#F28C5E] to-[#2A4A52]">
              Unfair Advantage.
            </span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-5 w-full sm:w-auto relative z-10">
            <Link
              href="/contact"
              className="group relative flex items-center justify-center gap-3 px-10 py-5 bg-[#E8622A] text-white font-black uppercase tracking-widest text-sm rounded-xl shadow-[0_0_30px_rgba(232,98,42,0.25)] hover:shadow-[0_0_50px_rgba(232,98,42,0.5)] hover:-translate-y-1 transition-all duration-300 overflow-hidden"
            >
            ...
            <Link
              ...
              className="group flex items-center justify-center gap-3 px-10 py-5 bg-transparent border-2 border-white/10 hover:border-[#F28C5E] hover:bg-[#F28C5E]/5 text-gray-300 hover:text-[#F28C5E] rounded-xl font-bold uppercase tracking-widest text-sm transition-all duration-300"
            >
              Email Us Directly
